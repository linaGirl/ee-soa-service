!function() {
    ...
    var   Class             = require('ee-class')
        ...
        , SubRequestHandler = require('./SubRequestHandler');
    ...
    module.exports = new Class({
        ...
        , init: function(options, tableName) {
            ...
            // subrequest handler
            this._subrequests = new SubRequestHandler({
            ...
            // the subrequest handler may send requests :)
            this._subrequests.on('request', function(request, response) {
