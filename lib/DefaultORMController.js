    ...
    !function() {
        ...
        module.exports = new Class({
                    ...
                    if(subRequests) {
                        subRequests.forEach(function(subRequest) {
                            ...
                            if(Object.hasOwnProperty.call(this.specs.hasOne, collection)) {
                                ...
                                return this._handleHasOneSubRequest(entities, subRequest);
                            }
            ...
            , _handleHasOneSubRequest: function(entities, subRequest) {
                var map        = {};
                var ids        = [];
                ids = function(entities) {
                    var _ids           = [];
            ...
            , listOne: function(queryData, callback) {
                ...
                //     }.bind(this));
                // }
                idsCheck[this.specs.primaryKey] = queryData.getResourceId();

                this.rootQuery(queryData.getFields(), idsCheck).findOne(function(err, data) {
                    callback(err, data);
                }.bind(this));
            }
