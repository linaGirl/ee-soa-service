        ...
        module.exports = new Class({
            ...
            , applyRowRestrictions: function(request, query) {
                ...
                if (request.permissions && query.setRestrictions) {
                    ...
                    // set some variables
                    if (request.permissions.hasUser()) query.setRestrictionVariable('tenantId', request.permissions.getFirstUser().id);
                    if (request.permissions.hasTenant()) query.setRestrictionVariable('userId', request.permissions.getFirstTenant().id);
                }
            }
