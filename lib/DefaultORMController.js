    ...
    !function() {
        ...
        module.exports = new Class({
            ...
            , _getSingleModel: function(queryData, baseQuery, callback) {
                ...
                // row restrictions
                if (queryData.permissions && query.setRestrictions) query.setRestrictions(queryData.permissions.getRowRestrictions());
                ...
                queryData.getContent(function(err, content) {
                    if (err) return callback(err);
                        ...
                        this.resolveReferences(content).then(function() {
                            ...
                            // row restrictions
                            if (queryData.permissions && record.setRestrictions) record.setRestrictions(queryData.permissions.getRowRestrictions());
                ...
                if(Object.hasOwnProperty.call(this.specs.hasOne, withModel)) {
                    this._getSingleModel(queryData, baseQuery, function(err, data) {
                        ...
                        if(data) {
                            ...
                            // row restrictions
                            if (queryData.permissions && data.setRestrictions) data.setRestrictions(queryData.permissions.getRowRestrictions());
                ...
                if(Object.hasOwnProperty.call(this.specs.belongsTo, withModel)) {
                    this._getSingleModel(queryData, baseQuery, function(err, entity) {
                        ...
                        if(entity) {
                            ...
                            // row restrictions
                            if (queryData.permissions && entity.setRestrictions) entity.setRestrictions(queryData.permissions.getRowRestrictions());
                ...
                queryData.getContent(function(err, content) {
                    ...
                    if(Object.hasOwnProperty.call(this.specs.hasMany, withModel)) {
                        ...
                        this.root[this.specs.hasMany[withModel].table.name](['*'], idFilter).findOne(function(err, mapping) {
                            ...
                            // row restrictions
                            if (queryData.permissions && mapping.setRestrictions) mapping.setRestrictions(queryData.permissions.getRowRestrictions());
