    ...
    !function() {
        ...
        module.exports = new Class({
                    ...
                    switch (req.action) {
                        case 'listOne':
                            this._controllerCollection[req.controller].listOne(req, function(err, result) {
                                this._handleResponse(err, result, req, res);
                            }.bind(this));
                        	break;
                        case 'list':
            ...
            , _internalRequest: function(req, res) {

            }

            , _handleResponse: function(err, result, req, res) {
                if(err) log(err);
            ...
            , _initController: function() {
                ...
                this._conf.controllersToLoad.forEach(function(controller, index) {
                    ...
                    newController.on('internalRequest', function(subRequest, callback) {
