                ...
                if(this._hasController(collection)) {
                    ...
                    switch (action) {
                        ...
                        case 'reference': //FIXME: maybe the same as 'mapping'
                            this._controllerCollection[collection].createReference(req, function(err, result) {
                                this._handleResponse(err, result, req, callback);
                            }.bind(this));
                            break;
                        case 'mapping':
                            this._controllerCollection[collection].createMapping(req, function(err, result) {
                                this._handleResponse(err, result, req, callback);
                            }.bind(this));
                            break;
                        case 'delete':
