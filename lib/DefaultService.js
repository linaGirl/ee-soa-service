    ...
    !function() {
        ...
        module.exports = new Class({
            ...
            , _request: function(req, callback) {
                ...
                if (debugService) {
                    log.info('[DefaultService] incoming request on '+[this.name, req.getCollection(), req.getActionName()].join('.')+' ...');
                    ...
                    Callback = function(err) {
                        ...
                        else log.info('[DefaultService] '+[this.name, req.getCollection(), req.getActionName()].join('.')+' - the response is beeing sent!');
